RSI_Constellation_flightReady =
{
	...
	{	
		...
		fileItemLoadout = "Scripts/Loadouts/Vehicles/Default_Loadout_RSI_Constellation.xml",
...
RSI_Constellation_flightReady.AIProperties = 
{

DRAK_Caterpillar_CommandModule =
{
	Properties = 
	{	
		bDisableEngine = 0,
		...
		fileItemLoadout = "Scripts/Loadouts/Vehicles/Default_Loadout_DRAK_Caterpillar_CommandModule.xml",
...
DRAK_Caterpillar_CommandModule.AIProperties = 
{

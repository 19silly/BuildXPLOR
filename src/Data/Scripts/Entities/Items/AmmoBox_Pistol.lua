AmmoBox_Pistol = {
	...
	Properties = {
		...
		object_BoxModel = "Objects/buildingsets/human/lowtech/charlie/int/prop/uee_lawless_prop_ammobox_01.cgf",
		...
		object_Ammo0Recharges = "Objects/buildingsets/human/lowtech/charlie/int/prop/uee_lawless_prop_ammobox_01.cgf",
		numberOfRecharges = 0,
...
function AmmoCrate:OnInit()
	...
	Game.OnAmmoBox_PistolSpawned(givesFragGrenades); 
end
...
MakeUsable(AmmoBox_Pistol);


AmmoBox_Pistol.FlowEvents =
{
	Inputs =
	{
		Hide = { AmmoBox_Pistol.Event_Hide, "bool" },
		UnHide = { AmmoBox_Pistol.Event_UnHide, "bool" },
		Used = { AmmoBox_Pistol.Event_Used, "bool" },
		EnableUsable = { AmmoBox_Pistol.Event_EnableUsable, "bool" },
		DisableUsable = { AmmoBox_Pistol.Event_DisableUsable, "bool" },
	},
	Outputs =
	{
		Hide = "bool",

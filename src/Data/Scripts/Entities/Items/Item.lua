...
function Item:GetUsableMessage(userId, idx)
	if (self.item:IsUsed()) then
		return "";
	elseif (self.item:IsMounted()) then
		return "@use_mounted";
	else
		return "@use_item";
	end
...
function CreateTurret(name)
	...
	Turret.Properties.esFaction = "UEE";
...
--Gadgets--
----------------------------------------------------------------------------------------------------
CreateItemTable("Hologram");

Hologram.Properties.bPickable=1
Hologram.Properties.bUsable=1
Hologram.Properties.HitPoints=0
Hologram.Properties.Mass = 6
Hologram.Properties.SlotSize = 1
Hologram.Properties.Uses = 1
Hologram.Properties.KeepOwnerWhenPlaced = 0
--Hologram.Properties.bPhysics=1

----------------------------------------------------------------------------------------------------
CreateItemTable("AreaDenialSystem");

AreaDenialSystem.Properties.bPickable=1
AreaDenialSystem.Properties.bUsable=1
AreaDenialSystem.Properties.HitPoints=200
AreaDenialSystem.Properties.Mass = 6
AreaDenialSystem.Properties.SlotSize = 2
AreaDenialSystem.Properties.Uses = 1
AreaDenialSystem.Properties.Radius = 2
AreaDenialSystem.Properties.Range = 6
AreaDenialSystem.Properties.MaxDamage = 10
AreaDenialSystem.Properties.KeepOwnerWhenPlaced = 1
--AreaDenialSystem.Properties.bPhysics=1

----------------------------------------------------------------------------------------------------
CreateItemTable("DeployablePersonalShield");

DeployablePersonalShield.Properties.bPickable=1
DeployablePersonalShield.Properties.bUsable=1
DeployablePersonalShield.Properties.HitPoints=3000
DeployablePersonalShield.Properties.Mass = 10
DeployablePersonalShield.Properties.SlotSize = 1
DeployablePersonalShield.Properties.Uses = 1
DeployablePersonalShield.Properties.KeepOwnerWhenPlaced = 0
--DeployablePersonalShield.Properties.bPhysics=1

----------------------------------------------------------------------------------------------------
CreateItemTable("PersonalShield");
...
PersonalShield.Properties.KeepOwnerWhenPlaced = 0
--PersonalShield.Properties.bPhysics=1

----------------------------------------------------------------------------------------------------
CreateItemTable("PersonalMedicalAid");

PersonalMedicalAid.Properties.bPickable=1
PersonalMedicalAid.Properties.bUsable=1
PersonalMedicalAid.Properties.Mass = 10

AmmoBox_Rifle = {
	...
	Properties = {
		...
		object_BoxModel = "Objects/buildingsets/human/lowtech/charlie/int/prop/uee_lawless_prop_ammobox_02.cgf",
		...
		object_Ammo0Recharges = "Objects/buildingsets/human/lowtech/charlie/int/prop/uee_lawless_prop_ammobox_02.cgf",
		numberOfRecharges = 0,
...
function AmmoCrate:OnInit()
	...
	Game.OnAmmoBox_RifleSpawned(givesFragGrenades); 
end
...
MakeUsable(AmmoBox_Rifle);


AmmoBox_Rifle.FlowEvents =
{
	Inputs =
	{
		Hide = { AmmoBox_Rifle.Event_Hide, "bool" },
		UnHide = { AmmoBox_Rifle.Event_UnHide, "bool" },
		Used = { AmmoBox_Rifle.Event_Used, "bool" },
		EnableUsable = { AmmoBox_Rifle.Event_EnableUsable, "bool" },
		DisableUsable = { AmmoBox_Rifle.Event_DisableUsable, "bool" },
	},
	Outputs =
	{
		Hide = "bool",

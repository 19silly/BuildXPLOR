ConversationBubble = 
{
	Properties = {
		...
		bNPCRadiusChecks = 1, 	 						-- Do we need other NPC participants to be in the bubble radii to start this conversation
		bFOVandDOFeffects = 1, 							-- Toggle FOV and DOF effects for this bubble
		...
		sDataForgeLookAtEntity1 = "",				-- Name of the optional look at entity 1 which can be focussed on via the conversation in DataForge
		sDataForgeLookAtEntity2 = "",				-- Name of the optional look at entity 2 which can be focussed on via the conversation in DataForge

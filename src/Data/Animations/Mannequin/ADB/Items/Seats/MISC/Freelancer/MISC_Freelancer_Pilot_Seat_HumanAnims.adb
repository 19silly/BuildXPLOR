  ...
  <SeatDriver>
   ...
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Enter">
    <AnimLayer>
     ...
     <Animation name="misc_freelancer_base_cockpit_pilot_enter"/>
    </AnimLayer>
   </Fragment>
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Idle">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="misc_freelancer_base_cockpit_pilot_idle" flags="Loop"/>
    </AnimLayer>
   </Fragment>
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Exit">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Animation name="misc_freelancer_base_cockpit_pilot_exit"/>
    </AnimLayer>
   </Fragment>
  </SeatDriver>
 </FragmentList>

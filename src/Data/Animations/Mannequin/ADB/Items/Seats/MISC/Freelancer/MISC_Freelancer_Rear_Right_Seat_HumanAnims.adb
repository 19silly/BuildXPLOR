<AnimDB FragDef="Animations/Mannequin/ADB/Items/Seats/MISC/Freelancer/MISC_Freelancer_Rear_Right_Seat_Fragments.xml" TagDef="Animations/Mannequin/ADB/items/seatTags.xml">
 <FragmentList>
  <SeatDriver>
   ...
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Enter">
    <AnimLayer>
     ...
     <Animation name="misc_freelancer_base_cockpit_rear_right_seat_enter"/>
    </AnimLayer>
   </Fragment>
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Idle">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="misc_freelancer_base_cockpit_rear_right_seat_idle" flags="Loop"/>
    </AnimLayer>
   </Fragment>
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Exit">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Animation name="misc_freelancer_base_cockpit_rear_right_seat_exit"/>
    </AnimLayer>
   </Fragment>
  </SeatDriver>
 </FragmentList>

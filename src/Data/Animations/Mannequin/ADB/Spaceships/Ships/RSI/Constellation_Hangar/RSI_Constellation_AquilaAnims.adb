 ...
 <FragmentList>
  ...
  <Gunner>
   <Fragment Tags="RSI_Constellation" FragTags="Enter">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Top_Chair_Deploy" crcString="gunner_sit_pos">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="8.058547" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Top_Ext_Deploy" crcString="Const_ext_Upper_Turret_Doors001">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
   ...
   <Fragment Tags="RSI_Constellation" FragTags="Exit">
    ...
    <ProcLayer>
     <Blend ExitTime="2.6093748" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Top_Ext_Retract" crcString="Const_ext_Upper_Turret_Doors001">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="5.9008584" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Top_Chair_Retract" crcString="gunner_sit_pos">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
  ...
  <GunnerLower>
   <Fragment Tags="RSI_Constellation" FragTags="Enter">
    ...
    <ProcLayer>
     <Blend ExitTime="6" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Chair_Deploy" crcString="gunner_sit_lower_pos">
      <Params />
     </Procedural>
     <Blend ExitTime="5.1999998" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Ext_Deploy" crcString="Const_ext_Bottom_Turret_Doors">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="3.2" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Controls_Retract" crcString="gunner_lower_sit_pos">
      <Params />
     </Procedural>
     <Blend ExitTime="5.1999998" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Controls_Deploy" crcString="gunner_lower_sit_pos">
      <Params />
     </Procedural>
     <Blend ExitTime="5.6000004" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Int_Expand" crcString="gunner_lower_sit_pos">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
   <Fragment Tags="RSI_Constellation" FragTags="Exit">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Int_Collapse">
      <Params />
     </Procedural>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Ext_Retract" crcString="Const_ext_Bottom_Turret_Doors">
      <Params />
     </Procedural>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Chair_Retract" crcString="gunner_lower_sit_pos">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
   ...
   <Fragment Tags="RSI_Constellation" FragTags="Close">
    ...
    <ProcLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Turret_Bottom_Chair_Deploy" crcString="gunner_lower_sit_pos">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
  ...
  <Bulkhead_Rear_Door>
   <Fragment Tags="RSI_Constellation" FragTags="Open">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_RSI_Constellation_Bulkhead_Door_Rear_Open" crcString="door_rear_helper">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>

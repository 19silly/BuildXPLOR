<AnimDB FragDef="Animations/Mannequin/ADB/Spaceships/Ships/MISC/Freelancer/MISC_Freelancer_Fragments.xml" TagDef="Animations/Mannequin/ADB/Spaceships/spaceshipTags.xml">
 <FragmentList>
  <Pilot>
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Enter">
    <AnimLayer>
   ...
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Exit">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
  ...
  <Gunner>
   ...
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Activate">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Animation name="Rear_Turret_Chair_Retract" speed="-1"/>
    </AnimLayer>
   </Fragment>
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Deactivate">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
  ...
  <Landing_Gear>
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Deploy">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_Landing_Gear_Front_Deploy"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_ext_landing_gear_front_arm_joint_001"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
       <PlayFacial value="false"/>
       <SoundFlags value="0"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_Landing_Gear_Rear_Deploy"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_ext_landing_gear_rear_joint"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
       <PlayFacial value="false"/>
       <SoundFlags value="0"/>
   ...
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Retract">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_Landing_Gear_Front_Retract"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_ext_landing_gear_front_arm_joint_001"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_Landing_Gear_Rear_Retract"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_ext_landing_gear_rear_joint"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
  ...
  <Entrance_Door>
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Open">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
   ...
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Close">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
  ...
  <Rear_Door>
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Open">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_RearDoor_Open"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_int_door_rear_hinge"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
       <PlayFacial value="false"/>
       <SoundFlags value="0"/>
   ...
   <Fragment BlendOutDuration="0.2" Tags="MISC_Freelancer" FragTags="Close">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_SSMP_MISC_Freelancer_RearDoor_Close"/>
       <StopTrigger value=""/>
       <AttachmentJoint value="FL_int_door_rear_hinge"/>
       <Radius value="0"/>
       <IsVoice value="false"/>

  ...
  <rear_door>
   ...
   <Fragment BlendOutDuration="0.2" Tags="" FragTags="Close">
    ...
    <ProcLayer>
     ...
     <Procedural type="ParticleEffect">
      <ProceduralParams>
       <EffectName value="spaceship_fx.Cockpit.hydraulics_short"/>
       <JointName value="Rear_door_ZERO"/>
       <AttachmentName value=""/>
       <PosOffset>
        <Element value="-1.0496945"/>
        <Element value="-2.1723948"/>
        <Element value="2.1663013"/>
       </PosOffset>
       <RotOffset>
        <Element value="-2.3246057"/>
        <Element value="-0.022283759"/>
        <Element value="0.18384512"/>
       </RotOffset>
       <CloneAttachment value="false"/>
       <KillOnExit value="false"/>
       <KeepEmitterActive value="false"/>
     ...
     <Blend ExitTime="12.675" StartTime="0" Duration="0.2"/>
     <Procedural type=""/>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="0.125" StartTime="0" Duration="0"/>
     <Procedural type="ParticleEffect">
      <ProceduralParams>
       ...
       <AttachmentName value=""/>
       <PosOffset>
        <Element value="1.054464"/>
        <Element value="-1.7811371"/>
        <Element value="2.2140017"/>
       </PosOffset>
       <RotOffset>
        <Element value="-2.3246057"/>
        <Element value="-0.022283755"/>
        <Element value="0.1838451"/>
       </RotOffset>
       <CloneAttachment value="false"/>
       <KillOnExit value="false"/>
       <KeepEmitterActive value="false"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       ...
       <StopTrigger value=""/>
       <AttachmentJoint value="turret_player_mount_pos"/>
       <Radius value="0"/>
       <IsVoice value="false"/>
       <PlayFacial value="false"/>
       <SoundFlags value="0"/>

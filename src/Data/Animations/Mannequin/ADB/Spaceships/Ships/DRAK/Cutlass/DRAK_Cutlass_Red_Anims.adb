 ...
 <FragmentList>
  ...
  <SeatDriver>
   ...
   <Fragment Tags="" FragTags="Exit">
    <AnimLayer>
     ...
     <Animation name="cockpit_pilot_mount" speed="-1"/>
    </AnimLayer>
    <ProcLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_DRAK_Cutlass_Computer_Display_Open" crcString="interior_cockpit_screen_pilot">
  ...
  <rear_door>
   <Fragment Tags="" FragTags="Open">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio" string="Play_SSMP_DRAK_Cutlass_Cargo_Door_Open" crcString="rear_door_male_piston">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
   <Fragment Tags="" FragTags="Close">
    ...
    <ProcLayer>
     <Blend ExitTime="0.5" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_DRAK_Cutlass_Cargo_Door_Close" crcString="rear_door_male_piston">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
  ...
  <cockpit_door>
   <Fragment Tags="" FragTags="Open">
    ...
    <ProcLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
     <Procedural type="Audio" string="Play_SSMP_DRAK_Cutlass_Door_Open" crcString="cockpit_door_right_003">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>

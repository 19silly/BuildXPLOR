  ...
  <SeatDriver>
   ...
   <Fragment Tags="" FragTags="Wakeup">
    ...
    <ProcLayer>
     ...
     <Procedural type="AttachLimbIKVehicle" string="LftArm01|cockpit_control_stick_left_IK_attach">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="2.73" StartTime="0" Duration="0.47220349"/>
     <Procedural type="AttachLimbIKVehicle" string="RgtArm01|cockpit_control_stick_right_IK_attach">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
    ...
    <ProcLayer>
     ...
     <Procedural type="AttachLimbIKVehicle" string="RgtLeg01|cockpit_pedal_right_IK_attach">
      <Params />
     </Procedural>
    </ProcLayer>
    <ProcLayer>
     <Blend ExitTime="2.73" StartTime="0" Duration="0.4652009"/>
     <Procedural type="AttachLimbIKVehicle" string="LftLeg01|cockpit_pedal_left_IK_attach">
      <Params />
     </Procedural>
    </ProcLayer>
   </Fragment>
